...
def main():
  ...
  parser.add_argument('--inventoryoutputfile', dest='inventoryoutputfile', default='', help='Full path to the desired inventory output file. Requires --decklistoutputfile if used. (default=magicdeckboxinventory.csv in the output directory option)')
  parser.add_argument('--decklistoutputfile', dest='decklistoutputfile', default='', help='Full path to the desired decklist output file. Requires --inventoryoutputfile if used. (default=magiccollection.dec in the output directory option)')
  parser.add_argument('--outputdirectory', dest='outputdirectory', default='', help='Directory in which to place the generated inventory & decklist files. (default=~/Dropbox, ~/Ubuntu One, or the current working directory)')
  ...
  elif not args.outputdirectory == '':
    inventoryOutputFileStr = args.outputdirectory + '/magicdeckboxinventory.csv'
    decklistOutputFileStr = args.outputdirectory + '/magiccollection.dec'
  else:
    if os.path.exists(home + '/Dropbox'):
      outputdirectoryprefix = home + '/Dropbox'
    elif os.path.exists(home + '/Ubuntu One'):
      outputdirectoryprefix = home + '/Ubuntu One'
    else:
